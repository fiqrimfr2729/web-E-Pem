                    ...
                    <tr class="tr-shadow">
                        ...
                        <td>
                            <div>
                                ...
                                <button type="button" onclick="window.location.href='<?php echo base_url('admin/' . strtolower(str_replace(' ', '_', $title_dashboard)) . '/infoProduk/' . $data_produk->id_produk) ?>'" class="btn btn-info">Info</button>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
